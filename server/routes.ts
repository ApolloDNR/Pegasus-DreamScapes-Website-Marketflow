...
export async function registerRoutes(
  ...
  app.get('/sitemap.xml', async (req, res) => {
    ...
    const staticRoutes: { path: string; priority: string; changefreq: string }[] = [
      ...
      { path: '/deal-architecture', priority: '0.9', changefreq: 'monthly' },
      ...
      { path: '/work-with-apollo', priority: '0.8', changefreq: 'monthly' },
      { path: '/marketflow', priority: '0.8', changefreq: 'monthly' },
      { path: '/about', priority: '0.8', changefreq: 'monthly' },
      { path: '/ecosystem', priority: '0.7', changefreq: 'monthly' },
      { path: '/dreamscaper-standard', priority: '0.7', changefreq: 'monthly' },
      { path: '/peggy-ai', priority: '0.7', changefreq: 'monthly' },
