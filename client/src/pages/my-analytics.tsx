        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-2" data-testid="heading-analytics">
              ...
              My Analytics
              {isDemoMode && (
                <Badge variant="secondary" className="text-xs">Sign-in needed</Badge>
              )}
            </h1>
            <p className="text-muted-foreground">
              Verified activity when available, plus deterministic estimates from assumptions you enter.
            </p>
          </div>
        </div>

        <Tabs defaultValue="dashboard" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 lg:w-auto lg:inline-grid" data-testid="analytics-tabs">
            ...
            <TabsTrigger value="scenario" className="gap-2" data-testid="tab-scenario">
              ...
              <span className="hidden sm:inline">Scenario Model</span>
            </TabsTrigger>
          </TabsList>
