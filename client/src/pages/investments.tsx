    ...
    <div className="bg-background">
      ...
      <Section variant="hero" className="overflow-hidden">
        ...
        <div className="container-premium relative pt-36 pb-20 md:pt-44 md:pb-28">
          ...
          <Reveal delay={280}>
            <p className="mt-12 max-w-2xl text-[12px] uppercase tracking-[0.22em] text-muted-foreground/70">
        ...
        <div className="container-premium section-y">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16 lg:items-center">
            ...
            <Reveal delay={120} className="lg:col-span-6">
              <div className="rounded-sm border border-copper/25 bg-card p-9">
                ...
                <ul className="mt-6 space-y-3">
                  {reporting.map((r) => (
                    <li key={r} className="flex gap-3 text-[15px] text-foreground/85">
      ...
      <Section variant="ink">
        <div className="container-premium section-y">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-10 text-[11px] uppercase tracking-[0.22em] text-muted-foreground/70">
