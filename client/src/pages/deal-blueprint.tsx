            ...
            <StaggerItem key={i}>
              <div className="h-full p-8 bg-card rounded-lg border border-border/40" data-testid={`audience-${i}`}>
                <div className="flex items-baseline justify-between mb-6">
                  <p className="text-[10px] uppercase tracking-[0.28em] text-primary font-supporting font-semibold">{a.kicker}</p>
            ...
            <StaggerItem key={i}>
              ...
              >
                <div className="flex items-baseline justify-between mb-5">
                  <p className="text-[10px] uppercase tracking-[0.28em] text-primary font-supporting font-semibold">{tier.kicker}</p>
                  {tier.featured && (
                    <span className="text-[10px] uppercase tracking-[0.22em] text-primary/80 font-supporting font-semibold border border-primary/30 px-2 py-0.5 rounded">
                      Most common
                    </span>
                  )}
                </div>
                ...
                <div className="pt-5 border-t border-border/40">
                  <p className="text-[10px] uppercase tracking-[0.22em] text-muted-foreground font-supporting font-semibold mb-1">Investment</p>
