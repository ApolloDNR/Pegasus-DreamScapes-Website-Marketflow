...
function HeroSection() {
  return (
    <section className="relative bg-[hsl(var(--charcoal))] text-cream overflow-hidden border-b border-cream/10">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 pt-32 lg:pt-36 pb-16 lg:pb-20">
        <motion.div
        ...
        <motion.h1
          className="font-serif text-3xl sm:text-4xl lg:text-6xl font-normal text-cream leading-[1.12] tracking-normal mb-8 max-w-4xl [text-shadow:0_2px_14px_rgba(0,0,0,0.5)]"
        ...
        >
          <Button asChild
              size="lg"
              className="text-sm tracking-normal px-6 py-4 whitespace-normal text-center bg-white text-slate-900 hover:bg-white/95 font-semibold shadow-md shadow-black/20 w-full sm:w-auto"
          ...
          <Button asChild
              size="lg"
              variant="outline"
              className="w-full sm:w-auto text-sm tracking-normal px-6 py-4 whitespace-normal text-center border-cream/30 text-cream hover:bg-cream/10 backdrop-blur-md font-semibold"
...
function WhatsInside() {
  ...
  return (
    <section id="blueprint-contents" className="editorial-section bg-background">
...
function WhenItsRight() {
  ...
  return (
    <section id="blueprint-fit" className="editorial-section bg-muted/20">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
...
function HowItWorks() {
  ...
  return (
    <section id="blueprint-process" className="editorial-section bg-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <ScrollReveal className="max-w-3xl mb-10">
          <div className="flex items-center gap-4 mb-6">
            <div className="h-px w-16 bg-gradient-to-r from-primary to-transparent" />
        ...
        <ol className="editorial-process">
          {steps.map((step, i) => (
            <li key={step.tag} data-testid={`blueprint-step-${i}`}>
              <span className="editorial-step-number" aria-hidden="true">0{i + 1}</span>
              <h3>{step.title}</h3>
              <p>{step.desc}</p>
            </li>
          ))}
...
function PricingSection() {
  return (
    <section id="blueprint-pricing" className="editorial-section bg-muted/20">
...
function CTASection() {
  return (
    <section className="editorial-section bg-card relative overflow-hidden">
      <div className="absolute inset-0">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 relative text-center">
        <ScrollReveal>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild
                size="lg"
                className="text-sm tracking-normal px-6 py-4 whitespace-normal text-center font-semibold"
...
export default function DealBlueprintPage() {
  ...
  return (
    <div className="pg-editorial blueprint-editorial min-h-screen bg-background">
      <HeroSection />
      <EditorialSections items={[["blueprint-contents", "Contents"], ["blueprint-fit", "Fit"], ["blueprint-process", "Process"], ["blueprint-pricing", "Pricing"]]} />
      <WhatsInside />
      <WhenItsRight />
      <HowItWorks />
      <PricingSection />
