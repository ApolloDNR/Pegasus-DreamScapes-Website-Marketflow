  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <section className="border-b border-[hsl(var(--rule))]">
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10 pt-24 pb-12">
          ...
          <p className="font-serif text-lg text-muted-foreground mt-3 max-w-2xl">Every property you've run through the Pegasus lens. Open it back up, refresh the math, share it with a partner, or submit it for a written Property Read.</p>
          <div className="mt-6">
