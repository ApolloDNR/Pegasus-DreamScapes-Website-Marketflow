...
function getQuickPrompts(page?: string): QuickPrompt[] {
  const routerPrompts: QuickPrompt[] = [
    ...
    { icon: BookOpen, label: "Learn strategies", prompt: "I want to learn the strategies. Point me to the strategy resources.", context: "router", href: "/resources" },
    { icon: Network, label: "Vendor or operator", prompt: "I'm a vendor or operator interested in the Pegasus network. What's the right way in?", context: "router", href: "/contact" },
  ];
