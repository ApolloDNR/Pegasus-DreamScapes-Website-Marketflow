...
export type CalcTabKey = (typeof CALC_TABS)[number];


export function readActiveTabFromUrl(): CalcTabKey {
...
export const CALC_TABS = ["arv", "roi", "brrrr", "cashflow", "wholesale", "piti", "ownvsrent", "hardmoney"] as const;
