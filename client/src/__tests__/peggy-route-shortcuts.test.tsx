 ...
 * Strategy Lab / Submit a Property / Ask About Representation / MarketFlow.
...
describe("Peggy — persistent route shortcuts", () => {
  ...
  it("Ask About Representation shortcut navigates to the apollo lane and closes the panel", () => {
